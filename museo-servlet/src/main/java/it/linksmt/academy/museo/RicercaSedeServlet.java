...
public class RicercaSedeServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public RicercaSedeServlet() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        try {
            ...
            request.setAttribute("errorMessage", "Impossibile recuperare la lista delle sedi. Si prega di riprovare più tardi.");
        }


        RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/view/listaSedi.jsp");
